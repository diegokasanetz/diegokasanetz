...
public class ConsultasClientes extends javax.swing.JInternalFrame {
    ...
    void Cargarlistaclientes()          
    {
        ...
        String []Titulos = {"CODIGO","NOMBRES","APELLIDOS","SEXO","DNI","TELEFONO","RUC","EMAIL","DIRECCION","CLASES"};
        ...
        try {
            ...
            while(rs.next())
            {
                ...
                registros[9]=rs.getString("clas_cli");
    ...
    private void initComponents() {
        ...
        rdgenero.setText("Mostrar Alumnos por Genero:");
        ...
        rdtodo.setText("Mostrar todos los alumnos");
        ...
        getAccessibleContext().setAccessibleName("CONSULTA DE ALUMNOS");
...
// TODO add your handling code here:
   ...
   {
       DefaultTableModel modelo= new DefaultTableModel();
       String []Titulos = {"CODIGO","NOMBRES","APELLIDOS","SEXO","CI","TELEFONO","RUC","EMAIL","DIRECCION","CLASES"};
       modelo.setColumnIdentifiers(Titulos);
       this.tbclientes.setModel(modelo);
       try {
