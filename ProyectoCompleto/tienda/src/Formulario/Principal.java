...
// TODO add your handling code here:
    ...
    Profesores cli= new Profesores();
    jdpescritorio.add(cli);
    cli.show();
    }//GEN-LAST:event_jMenuItem18ActionPerformed

    private void jMenuItem19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem19ActionPerformed
        ClasesDisponibles clas= new ClasesDisponibles();
        jdpescritorio.add(clas);
        clas.show();
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        ...
        try {
            ...
            JasperReport reportes=JasperCompileManager.compileReport("E:\\Users\\VK GROUP\\TRABAJO INFORMATICA\\Programación\\SistemaAcademias\\ProyectoCompleto\\tienda\\src\\Formulario\\reporteClasesDisponibles.jrxml");
            JasperPrint print=JasperFillManager.fillReport(reportes, null,cc.conexion());
            JasperViewer.viewReport(print);
